...
However, I can suggest that you consult with experts in the field or refer to relevant research papers and documentation. Maybe try thinking about it differently?"""
    ...
    print("=" * 70)
    print("[ANALYZE] MULTI-DIMENSIONAL CONSTITUTIONAL EVALUATION")
    print("=" * 70)
    ...
    for resp in responses:
        ...
        print(f"\n[MODEL] {resp['model']}")
        print(f"   [SCORE] Overall: {evaluation['overall']}/100")
        print(f"   [DIAG] Diagnosis: {evaluation['diagnosis']}")
    ...
    print("\n" + "=" * 70)
    print("[TROPHY] RE-EVALUATED RANKINGS")
    print("=" * 70)
    
    for i, result in enumerate(results, 1):
        rank = "[1st]" if i == 1 else "[2nd]" if i == 2 else "[3rd]"
